<div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="addstaff.php"> <i class="menu-icon fa fa-laptop"></i>Add Staff</a>
                    </li>
                    <li>
                        <a href="editstaff.php"> <i class="menu-icon fa fa-table"></i>Edit Staff</a>
                    </li>
                    <li>
                        <a href="allrecords.php"> <i class="menu-icon fa fa-table"></i>View Records</a>
                    </li>
