...
$user_det = userDet() ;
$staffs = $dataRead->get_all_staffs() ;
user3($user_det['access_id']) ;
?>
<!doctype html>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                    <?php
                        while($fetch = mysqli_fetch_assoc($staffs))
                        {
                    ?>
                      <tr>
                        <td><a href="editstaff.php?s=<?php echo $fetch['user_id'] ?>"><?php echo $fetch['fullname']; ?></td>
                        <td><?php echo getAccess($fetch['access_id']); ?></td>
