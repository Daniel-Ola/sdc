                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="p_id" id="p_id" value="<?php echo $_GET['p'] ; ?>" style="display: none;">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="mx-auto d-block">
                                                                <a href="<?php echo 'images/uploads/students/'.$case_det['stud_pic'] ; ?>" target="_new"><img src="<?php echo 'images/uploads/students/'.$case_det['stud_pic'] ; ?>" style="width: 200px !important; height: 200px !important;"></a>
                                            ...
                                            <div class="panel row">
                                                <div class="col-md-12">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="mx-auto d-block">
                                                                <a href="<?php echo 'images/uploads/cases/'.$case_det['case_stat'] ; ?>" target="_new"><img src="<?php echo 'images/uploads/cases/'.$case_det['case_stat'] ; ?>" style="width: 200px !important; height: 200px !important;"></a>
                                                                <div class="location text-sm-center">Case Statement</div>
