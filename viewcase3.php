                        ...
                        <div class="col-md-6 text-center">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="nf-password" class=" form-control-label">Student's Id</label>
                                        ...
                                        <div class="form-group">
                                            <button class="accordion" type="button">Case Statement</button>
                                            <div class="panel">
                                        ...
                                        <div class="form-group">
                                            <button class="accordion" type="button">Punishment Statement</button>
                                            <div class="panel">
                                              <p><?php echo getPunishment($pid) ; ?></p>
                                            </div>
                                        </div>
